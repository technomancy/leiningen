...
* Debian packaging
  ...
  - [x] package simple libs
        need clucy license clarification
        need lancet pushed upstream to stu
  - [x] man page
  - [ ] rules: binary
        handle bin script, (package.install?) version in jar filename
  - [ ] please please don't make me depend on groovy
* For 2.0
